...
class SEO extends Component {
  render() {
    ...
    if (postSEO || pageSEO) {
      title = postNode.titre
      description = typeof postNode.yoast !== 'undefined' && postNode.yoast.metadesc === null ? postNode.excerpt : postNode.content

      pageUrl = config.siteUrl + '/' + pagePath + '/'
    }
    // Use Hero Image for OpenGraph
    if (postSEO) {
      image = typeof postNode.featured_media !== 'undefined' ? postNode.featured_media.source_url : null
    }
